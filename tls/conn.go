...
// getClientCertificate returns the client certificate to send to the server, if any.
// For scanning use-cases we typically do not send client certificates; this exists
// to keep parity with crypto/tls and to support mutual-TLS scanning if desired.
